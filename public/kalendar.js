let Kalendar = (function(){
    ...
    function imaLiPresjekaVremenaImpl(pocetak, kraj, zauzeto_pocetak, zauzeto_kraj){
    ...
    function obojiZauzecaImpl(kalendarRef, mjesec, sala, pocetak, kraj){ 
        ...
        for(let i = 0 ; i < periodicneIzmjene.length; i++){
            ...
            if(zauzeto.naziv === sala  && jeLiSpadaUSemetar(mjesec, zauzeto.semestar)){
                if(imaLiPresjekaVremenaImpl(pocetak,kraj,zauzeto.pocetak,zauzeto.kraj)) {
                    for(let j = (parseInt(zauzeto.dan) + ( 8 - dajPrviDan(mjesec)))%7; j < dani.length;  j += 7){
        ...
        for(let i = 0 ; i < vanredneIzmjene.length; i++){
            ...
            if(zauzeto.naziv === sala  && (mjesec+1) === mm && yyyy == new Date().getFullYear()){
                if(imaLiPresjekaVremenaImpl(pocetak,kraj,zauzeto.pocetak,zauzeto.kraj)) {
    ...
    return {
        ...
        imaLiPresjekaVremena : imaLiPresjekaVremenaImpl
    }
}());
